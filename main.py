...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        self.spin_crop_padding = QtWidgets.QSpinBox()
        self.spin_crop_padding.setRange(0, 10)
        self.spin_crop_padding.setValue(4)
        self.spin_refine_iter = QtWidgets.QSpinBox()
        self.spin_refine_iter.setRange(1, 5)
        self.spin_refine_iter.setValue(3)
        self.spin_seam_band = QtWidgets.QSpinBox()
        self.spin_seam_band.setRange(10, 80)
        self.spin_seam_band.setValue(30)
        self.spin_max_scale = QtWidgets.QDoubleSpinBox()
        self.spin_max_scale.setRange(0.1, 1.0)
        self.spin_max_scale.setValue(0.5)
        self.spin_max_scale.setSingleStep(0.1)
        self.spin_max_edge_warp = QtWidgets.QSpinBox()
        self.spin_max_edge_warp.setRange(0, 3)
        self.spin_max_edge_warp.setValue(2)
        self.combo_compress = QtWidgets.QComboBox()
        self.combo_compress.addItems(["deflate", "lzw", "none"])
        self.chk_restoration = QtWidgets.QCheckBox("Restoration / Anti-Seam")
        self.chk_seam_fill = QtWidgets.QCheckBox("Seam Fill (микро-дорисовка)")
        ...
        params_layout.addWidget(QtWidgets.QLabel("crop-padding"), 4, 0)
        params_layout.addWidget(self.spin_crop_padding, 4, 1)
        params_layout.addWidget(QtWidgets.QLabel("refine-iterations"), 5, 0)
        params_layout.addWidget(self.spin_refine_iter, 5, 1)
        params_layout.addWidget(QtWidgets.QLabel("seam-band"), 6, 0)
        params_layout.addWidget(self.spin_seam_band, 6, 1)
        params_layout.addWidget(QtWidgets.QLabel("max-scale %"), 7, 0)
        params_layout.addWidget(self.spin_max_scale, 7, 1)
        params_layout.addWidget(QtWidgets.QLabel("max-edge-warp"), 8, 0)
        params_layout.addWidget(self.spin_max_edge_warp, 8, 1)
        params_layout.addWidget(self.chk_restoration, 9, 0, 1, 2)
        params_layout.addWidget(self.chk_seam_fill, 10, 0, 1, 2)
        params_layout.addWidget(self.chk_debug, 11, 0, 1, 2)
    ...
    def _collect_params(self) -> StitchParams:
        params = StitchParams(
            ...
            restoration_mode=self.chk_restoration.isChecked(),
            crop_padding_px=self.spin_crop_padding.value(),
            refine_iterations=self.spin_refine_iter.value(),
            seam_band_px=self.spin_seam_band.value(),
            max_scale_percent=self.spin_max_scale.value(),
            max_edge_warp_px=self.spin_max_edge_warp.value(),
            seam_fill_enabled=self.chk_seam_fill.isChecked(),
        )
